...
// 	title: 'Smart IPSC Training System',
...
export default function RootLayout({
	...
	// const [fullscreenButton, setFullscreenButton] = React.useState(true);
	...
	React.useEffect(() => {
		...
		// 		setFullscreenButton(!window.isFullScreen)
		// 	})
		// } else {
		...
		<html lang="en" id="ROOTHTML">
			...
			<body className={inter.className}>
				{/* {fullscreenButton ? <Button
					...
					onClick={() => {
						document.getElementById("ROOTHTML").requestFullscreen();
						setFullscreenButton(false);
					}}
				/> : <></>} */}
